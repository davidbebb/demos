...
lithium=plane.add(Part(name = 'Lithium', layer='Lithium', border=Rect(V(0,0), centred=True, width=li_width, height=li_height)))
pottassium=plane.add(Part(name = 'Potassium', layer='Potassium', border=Rect(V(0,0), centred=True, width=k_width, height=k_height)))
